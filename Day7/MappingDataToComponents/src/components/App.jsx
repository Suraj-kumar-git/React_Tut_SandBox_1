...
function createCard(props){ // Parameters can be named anything
  return <Card  // this createCard function is called for every item in the contacts[] of contacts.js file.
  key={props.id}
  id={props.id}
  name={props.name}
  img={props.imgURL}
